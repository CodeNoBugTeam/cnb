...
<body>
		...
		<div class="Advertising_list  clearfix" id="Sellerber">
					...
					<div class="list_content">
						<div class="side_list">
							<div class="column_title">
								<h4 class="lighter smaller">广告分类</h4>
							</div>
			...
			<div class="list_Exhibition list_show padding15">
				<div class="operation clearfix mb15 searchs_style">
					...
					<a href="javascript:" onClick="add_ads()" name=""
						class="btn button_btn bg-deep-blue" title="添加产品"><i
						class="fa  fa-edit"></i>&nbsp;添加广告</a> <span class="line30 r_f">数量：3433件</span>
				</div>
				<!--数据展示-->
							...
							<tbody>
								<tr>
									...
									<td><span class="ad_img"><a
											href="product_img/ad.jpg" class="zoomimg"><img
												src="product_img/ad.jpg" width="100%" height="100%" /></a></span></td>
									<td>1890x1080</td>
									...
									<td class="td-manage"><a
										...
										title="隐藏" class="btn btn-xs btn-status">隐藏</a> <a title="编辑"
										onclick="" href="javascript:;" class="btn btn-xs btn-info">编辑</a>
								...
								<tr>
									...
									<td>幻灯片</td>
									<td><span class="ad_img"><a
											href="product_img/1.jpg" class="zoomimg"><img
												src="product_img/1.jpg" width="100%" height="100%" /></a></span></td>
									<td>1890x1080</td>
									<td><a href="#" target="_blank">http://item.jd.com/10443270082.html</a></td>
									<td>2016-6-29 12:34</td>
									<td class="td-status"><span
								...
								<tr>
									...
									<td>幻灯片</td>
									<td><span class="ad_img"><a
											href="product_img/ad2.jpg" class="zoomimg"><img
												src="product_img/ad2.jpg" width="100%" height="100%" /></a></span></td>
									<td>1890x1080</td>
									<td><a href="#" target="_blank">http://item.jd.com/10443270082.html</a></td>
									<td>2016-6-29 12:34</td>
									<td class="td-status"><span
									...
									<td class="td-manage"><a style="text-decoration: none"
										class="btn btn-xs " onClick="member_start(this,id)"
										href="javascript:;" title="显示">显示</a> <a title="编辑" onclick=""
								...
								<tr>
									...
									<td>幻灯片</td>
									<td><span class="ad_img"><a
											href="product_img/ad1.jpg" class="zoomimg"><img
												src="product_img/ad1.jpg" width="100%" height="100%" /></a></span></td>
									<td>1890x1080</td>
									<td><a href="#" target="_blank">http://item.jd.com/10443270082.html</a></td>
									<td>2016-6-29 12:34</td>
									<td class="td-status"><span
								...
								<tr>
									...
									<td>通用广告</td>
									<td><span class="ad_img"><a
											href="product_img/ad3.jpg" class="zoomimg"><img
												src="product_img/ad3.jpg" width="100%" height="100%" /></a></span></td>
									<td>1890x1080</td>
									<td><a href="#" target="_blank">http://item.jd.com/10443270082.html</a></td>
									<td>2016-6-29 12:34</td>
									<td class="td-status"><span
	...
	<div id="Advert_add_style" class="Advert_add_style padding display">
		<div class="add_style">
			<ul>
				<li class="clearfix"><label class="label_name col-xs-2">图片名称：&nbsp;&nbsp;</label><span
					class="cont_style col-xs-9"><input name="图片名称" type="text"
						id="form-field-1" class="col-xs-10 col-sm-5" style="width: 450px"></span></li>
				<li class="clearfix"><label class="label_name col-xs-2">显示排序：&nbsp;&nbsp;</label><span
					class="cont_style col-xs-9"><input name="排序" type="text"
						id="form-field-1" placeholder="0" class="col-xs-10 col-sm-5"
						style="width: 50px"></span></li>
				<li class="clearfix"><label class="label_name col-xs-2">链接地址：&nbsp;&nbsp;</label><span
					class="cont_style col-xs-9"><input name="地址" type="text"
				...
				<li class="clearfix"><label class="label_name col-xs-2">状&nbsp;&nbsp;态：&nbsp;&nbsp;</label>
					<div class="Add_content col-xs-9">
						<label><input name="form-field-radio1" type="radio"
							checked="checked" class="ace"> <span class="lbl">显示</span></label>&nbsp;&nbsp;&nbsp;
						<label><input name="form-field-radio1" type="radio"
							class="ace"> <span class="lbl">隐藏</span></label>
					</div></li>
				<li class="clearfix"><label class="label_name col-xs-2">设置时间：&nbsp;&nbsp;</label>
					<div class="Add_content col-xs-9">
						<label class="l_f checkbox_time"><input type="checkbox"
							name="checkbox" class="ace" id="checkbox"><span
								class="lbl">是</span></label>
						<div class="Date_selection" style="display: none">
							<span class="label_name">开始日：</span>
							<p class="laydate-icon" id="start"
								style="width: 160px; margin-right: 10px; height: 30px; line-height: 30px; float: left"></p>
							<span class="label_name">结束日：</span>
							<p class="laydate-icon" id="end"
								style="width: 160px; height: 30px; line-height: 30px; float: left"></p>
						</div>
					</div></li>
				<li class="clearfix"><label class="label_name col-xs-2">图&nbsp;&nbsp;片：&nbsp;&nbsp;</label>
					<span class="cont_style col-xs-9">
						<div id="preview" class="preview_img">
							<img id="imghead" border="0" src="images/image.png" />
						</div>
						<div class="fileInput ">
							<input type="file" onchange="previewImage(this)" name="upfile"
								id="upfile" class="upfile" /> <input class="upFileBtn"
