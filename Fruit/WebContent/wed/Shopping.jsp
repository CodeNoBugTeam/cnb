			...
			<c:forEach items="${carList}" var="i">
				<ul class="order_lists">
					<li class="list_chk"><input type="checkbox"
						id="checkbox_${i }" class="son_check" name="fruit"
						value="${i.fin }"> <label for="checkbox_${i }"></label></li>
					<li class="list_con">
						<div class="list_img">
							<a href="javascript:;"><img src="${i.fipic}" alt=""></a>
						</div>
						<div class="list_text">
							<a href="javascript:;">${i.fname}${i.fdetails}</a>
						</div>
					</li>
					<li class="list_info">
						<p>规格：默认</p>
					...
					<li class="list_amount">
						<div class="amount_box">
							<a href="javascript:;" class="reduce reSty">-</a> <input
								type="text" value="1" class="sum" id="number"> <a
					...
					<li class="list_op">
						<p class="del">
							<a href="../customer.s?buy=deleteCar&fin=${i.fin}" class="delBtn">移除商品</a>
						</p>
					</li>
				</ul>
			</c:forEach>
		...
		<div class="bar-wrapper">
			<div class="bar-right">
				...
				<div class="totalMoney">
					共计: <span class="total_text">0.00</span>
				</div>
				<div class="calBtn">
					<input onclick="ck()" type="submit" value="结算"
						style="height: 49px; width: 100px; font-size: 26px; background: orange" />
				</div>
			</div>
		</div>
	</form>
