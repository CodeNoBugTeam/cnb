...
<meta charset="UTF-8">
<title>果然新鲜</title>
<link href="<%=request.getContextPath()%>/css/orange.css"
	rel="stylesheet">
...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/jquery.SuperSlide.2.1.1.js"></script>
</head>
<body>
	<!--顶部导航-->
		...
		<div class="cont-top">
			...
			<div class="cont-right">
				<div class="J_productTitle title g_minor">
					<span>南非进口黄柠檬 6个装</span> <span id="productQrCode"
						class="webSiteQrCode">&nbsp;
						<div class="code">
				...
				<div class="fk-pd5MallActBtns">
					<div class="buttn">加入购物车</div>
					<div class="buttn butto">立即购买</div>
				</div>
			</div>
		</div>
		...
		<div class="cont-bot">
			...
			<div class="bd">
				<div class="bd1" style="display: block">
					<img src="images/or-1.png"> <img src="images/or-2.png">
					<img src="images/or-3.png"> <img src="images/or-4.png">
				</div>
				<div class="bd1">
		...
		<div class="login">
			...
			<div class="lg-cont">
				<div class="lhd">
					...
					<div class="lhdfoot">
						<div class="lhdbottom"></div>
					</div>
				</div>
				<div class="lbd">
					<div class="lbd1" style="display: block">
						<div id="memberLoginAcct"
							class="J_memberLoginItem memberLoginDialogItem">
							<input id="memberAcct" class="generateInput memberAcctInput"
								type="text" value="" placeholder="账号">
						</div>
						<div id="memberLoginPwd"
							class="J_memberLoginItem memberLoginDialogItem itemSpace">
							<input id="memberPwd" class="generateInput memberPwdInput"
					...
					<div class="lbd1">
						<div class="msv">
							...
							<div class="memberSignupItem ">
								<div class="itemMiddle">
									<input type="password" id="memberSignupPwd" placeholder="密码"
										maxlength="50">
								</div>
								<div class="itemRight">*</div>
							</div>
							<div class="memberSignupItem">
								<div class="itemMiddle">
									<input type="password" id="memberSignupRepwd"
										placeholder="确认密码" maxlength="50">
								</div>
								<div class="itemRight">*</div>
							</div>
							<div class="memberSignupItem">
								<div class="itemMiddle">
									<input id="name" name="姓名" placeholder="姓名"
										class="userAddItem isCheckUAI" type="text" maxlength="50">
								</div>
								<div class="itemRight">*</div>
							</div>
							<div class="memberSignupItem">
								<div class="itemMiddle">
									<input id="email" name="邮箱" placeholder="邮箱"
										class="userAddItem" type="text" maxlength="50">
								</div>
								<div class="itemRight"></div>
							</div>
							<div class="memberSignupItem">
								<div class="itemMiddle">
									<input id="phone" name="电话" placeholder="电话"
										class="userAddItem" type="text" maxlength="50">
								</div>
								<div class="itemRight"></div>
							</div>
							<div class="memberSignupItem_remark">
								<div class="itemMiddle">
									<textarea id="memberSignupRemark" placeholder="留言"
