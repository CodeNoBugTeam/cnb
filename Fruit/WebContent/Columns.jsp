...
<body>
	<div class="margin" id="page_style">
		<div class="operation">
			...
			<span class="submenu"><a href="javascript:void(0)"
				class="btn button_btn bg-deep-blue" title="添加栏目"
				onclick="add_columns()"><i class="fa  fa-edit"></i>&nbsp;添加栏目</a></span>
		</div>
		<div class="Columns_list slideBox margin-top" id="Columns_list">
			...
			<div class="bd">
				<ul class="main_column">
					<table
						class="table table_list table_striped table-bordered  margin-top">
						<thead>
							<tr>
								<th width="7%">栏目名称</th>
								<th width="55%">链接地址</th>
													...
													<table>
														<tbody>
															<tr>
																...
																<td width="8%">一级</td>
																<td width="5%">显示</td>
																<td width="10%" class="operating"><a
																	href="javascrpit:void()"
																	class="btn btn-white button_btn"
																	onclick="columns_delete(this,'10')">删除</a> <a href=""
																	class="btn btn-white button_btn">修改</a></td>
															</tr>
														</tbody>
													</table>
												</div>
														...
														<tbody>
															<tr>
																...
																<td width="10%" class="operating"><a
																	href="javascrpit:void()"
																	class="btn btn-white button_btn"
																	onclick="columns_delete(this,'11')">删除</a> <a href=""
																	class="btn btn-white button_btn">修改</a></td>
															</tr>
														</tbody>
													</table>
														...
														<tbody>
															<tr>
																...
																<td width="10%" class="operating"><a
																	href="javascrpit:void()"
																	class="btn btn-white button_btn"
																	onclick="columns_delete(this,'12')">删除</a> <a href=""
																	class="btn btn-white button_btn">修改</a></td>
															</tr>
														</tbody>
													</table>
															...
															<table>
																<tbody>
																	<tr>
																		...
																		<td width="5%">显示</td>
																		<td width="10%"><a href=""
																			class="btn button_btn btn-danger">删除</a> <a href=""
																			class="btn button_btn btn-danger">修改</a></td>
																	</tr>
																</tbody>
															</table>
														</div>
													...
													<table>
														<tbody>
															<tr>
																...
																<td width="8%">一级</td>
																<td width="5%">显示</td>
																<td width="10%" class="operating"><a href=""
																	class="btn btn-white button_btn">删除</a> <a href=""
																	class="btn btn-white button_btn">修改</a></td>
															</tr>
														</tbody>
													</table>
														...
														<tbody>
															<tr>
																...
																<td width="10%" class="operating"><a
																	href="javascrpit:void()"
																	class="btn btn-white button_btn"
																	onclick="columns_delete(this,'14')">删除</a> <a href=""
																	class="btn btn-white button_btn">修改</a></td>
															</tr>
														</tbody>
													</table>
														...
														<tbody>
															<tr>
																...
																<td width="10%" class="operating"><a
																	href="javascrpit:void()"
																	class="btn btn-white button_btn"
																	onclick="columns_delete(this,'15')">删除</a> <a href=""
																	class="btn btn-white button_btn">修改</a></td>
															</tr>
														</tbody>
													</table>
				...
				<ul>
					<table class="table table_list table_striped table-bordered"
						id="sample-table" style="width: 100%">
						<thead>
							<tr>
								<th width="50">排序</th>
	...
	<!--添加栏目-->
	<div class="add_columns_style" id="add_columns_style"
		style="display: none">
		<div class="add_style">
			<ul>
				<li class="clearfix"><label class="label_name col-xs-3">导航栏目名称：&nbsp;&nbsp;</label>
				<div class="Add_content col-xs-9">
						<input name="" type="text" class="col-xs-6" />
					</div></li>
				<li class="clearfix"><label class="label_name col-xs-3">添加位置：&nbsp;&nbsp;</label>
					<div class="Add_content col-xs-9">
						<label><input type="radio" name="checkbox" class="ace"
							checked="checked"><span class="lbl">主栏目</span></label> <label><input
							type="radio" name="checkbox" class="ace"><span
								class="lbl">顶部</span></label> <label><input type="radio"
							name="checkbox" class="ace"><span class="lbl">底部</span></label>
					</div></li>
				<li class="clearfix"><label class="label_name col-xs-3">自定义链接：&nbsp;&nbsp;</label>
					<div class="Add_content col-xs-9">
						...
						<div class="Link_address" style="display: none">
							<input name="" type="text" class="col-xs-6"
								placeholder="如：http://www.jd.com/?cu=true" />
						</div>
					</div></li>
				<li class="clearfix"><label class="label_name col-xs-3">链接项目：&nbsp;&nbsp;</label>
				<div class="Add_content col-xs-9">
				...
				<li class="clearfix"><label class="label_name col-xs-3">上级分类：&nbsp;&nbsp;</label>
				<div class="Add_content col-xs-9">
				...
				<li class="clearfix"><label class="label_name col-xs-3">排序：&nbsp;&nbsp;</label>
				<div class="Add_content col-xs-9">
						<input name="" type="text" class="col-xs-1" />
					</div></li>
			</ul>
		</div>
	</div>
...
<script type="text/javascript">
	...
	var dataSet = [
			[
					'1',
					'帮助中心',
					'http://www.weiqing.com/help.php?name=23&id=1',
					'帮助中心',
					'启用',
					'2016-04-12',
					' <a href="javascrpit:void()" class="btn bg-deep-blue button_btn" onclick="top_columns_delete(this,'
							+ 15
							+ ')">删除</a><a href="" class="btn bg-deep-blue button_btn">修改</a>' ],
			[
					'1',
					'帮助中心',
					'http://www.weiqing.com/help.php?name=23&id=1',
