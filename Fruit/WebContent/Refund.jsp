...
<body>
	<div class="margin" id="page_style">
		<div class="Promp_plate label-success same_module">
			<b>提示：</b>暂时只支持未发货的订单退款申请，已发货订单咋不支持退款换货，请敬请谅解。<a
		...
		<div class="refund_style " id="refund">
			...
			<div class="operation clearfix mb15  searchs_style">
				<span class="l_f"> <a href="Add_Brand.html" title="添加品牌"
					class="btn button_btn bg-deep-blue"><i class="fa fa-plus"></i>批量处理</a>
					<a href="javascript:ovid()" class="btn  button_btn btn-danger"><i
						class="fa fa-trash"></i>批量删除</a> <a href="javascript:ovid()"
					class="btn  button_btn bg-yellow"><i class="fa fa-credit-card"></i>已退款</a>
					<a href="javascript:ovid()" class="btn  button_btn bg-green "><i
						class="fa  fa-credit-card-alt"></i>未退款</a>
				</span> <span class="r_f line30">共：<b>234</b>条
				</span>
			</div>
						...
						<tbody>
							<tr>
								...
								<td class="order_product_name"><a href="#"><img
										src="product_img/p_1.jpg" title="产品名称"></a> <i
									class="fa fa-plus"></i> <a href="#"><img
										src="product_img/p_2.jpg" title="产品名称"></a></td>
								<td>456.5</td>
								<td>2016-7-5</td>
								<td>145</td>
								<td>1</td>
								...
								<td><a onClick="Delivery_Refund(this,'10001')"
									href="javascript:;" title="退款" class="btn btn-xs btn-status">直接退款</a>
									<a title="退款订单详细" href="Refund_detailed.html"
							...
							<tr>
								...
								<td><a title="退款订单详细" href="Refund_detailed.html"
									class="btn btn-xs btn-info Refund_detailed">详细</a> <a
									title="删除" href="javascript:;"
									onclick="Order_form_del(this,'1')"
									class="btn btn-xs btn-danger">删除</a></td>
