					...
					<div class="user_left_info">
						<div class="clearfix">
							...
							<div class="form-group clearfix col-xs-3">
								...
								<div class="col-xs-9 line_height1 col-md-6">
									<input type="text" name="wtel" data-name="移动电话" id="phone"
										value="${editWorker.wtel}" class="col-xs-12 text_info"
										disabled="disabled" />
								</div>
							</div>
							<div class="form-group clearfix col-xs-3">
								...
								<div class="col-xs-9 line_height1 col-md-6">
									<input type="text" name="wemail" data-name="电子邮箱" id="mailbox"
										value="${editWorker.wemail}" class="col-xs-12 text_info"
										disabled="disabled" />
								</div>
							</div>
							<div class="form-group clearfix col-xs-3">
								...
								<div class="col-xs-9 line_height1 col-md-6">
									<input type="text" name="jointime" id="mailbox"
										value="${editWorker.jointime}" class="col-xs-12 text_info"
										disabled="disabled" />
								</div>
							</div>
						</div>
