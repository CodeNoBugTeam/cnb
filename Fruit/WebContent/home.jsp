		...
		<meta name="renderer" content="webkit|ie-comp|ie-stand">
			<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
				...
				<script type="text/javascript"
					src="http://api.map.baidu.com/api?v=2.0&ak=ZQVKW0dvz0tgMy6ZytmY5RxZ"></script>
				<!-- 加载百度地图样式信息窗口 -->
				<script type="text/javascript"
					...
					<div class="search_style">
						<form action="#" method="get" class="sidebar_form">
							<div class="input-group">
								<input type="text" name="q" id="jiansuo1" class="form-control"
									title="请输入关键字进行查询"> <span class="input-group-btn"><a
										class="btn_flat" href="javascript:" id="open1"
										onclick="refresh()"><i class="fa fa-search"></i></a></span>
							</div>
						</form>
					</div>
				</dd>
				<dd>
					<div class="area-text">
						...
						<p class="text_container">
							<script>
								var s = '（当日VLR登记用户数、昨日VLR登记用户数、上月平均值当日语音网络接通率、昨日语音网络接通';
