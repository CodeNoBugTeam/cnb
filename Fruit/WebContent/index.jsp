		...
		<div class="margin-bottom clearfix ">
			<div class="col-xs-2 col-sm-2 col-md-2 col-lg-4">
				<a href="javascript:ovid()"
					class="tile-button btn_Plate bg-deep-blue">
				...
				<div class="Shops_info clearfix frame">
					<div class="left_shop">
						<div class="left_shop_logo">
							<div class="shop_logo">
								<span class="bg_yuan"></span><img src="images/dp_logo.jpg" />
							</div>
							<a href="wed/index.jsp" class="btn bg-deep-blue paddings">进入首页</a>
						</div>
						<div class="Shops_content">
							<p>
								<label class="name">商城名称：</label>果然新鲜
							</p>
							<ul class="clearfix">
					...
					<div class="operating_style Quick_operation menuUl">
						<ul class="submenu">
							<li class=""><a href="add_product.jsp" class="btn"
								title="添加产品">添加产品</a></li>
							<li class=""><a href="allFruit.jsp" class="btn" title="添加广告">查看水果</a></li>
							<li class=""><a href="administrator_list.jsp" class="btn"
								title="查看管理员">查看管理员</a></li>
							<li class=""><a href="add_Article.jsp" class="btn"
								title="添加文章">添加文章</a></li>
							<li class=""><a href="add_Singlepag.jsp" class="btn"
								title="新增单页面">新增单页面</a></li>
						</ul>
					</div>
				</div>
			</div>
