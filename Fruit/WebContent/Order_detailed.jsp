		...
		<div class="detailed_style">
			...
			<div class="Receiver_style">
				...
				<div class="Info_style clearfix padding15">
					<div class="col-xs-3">
						<label class="label_name" for="form-field-2"> 收件人姓名： </label> <input
							type="text" name="name" style="height: 25px" />
					</div>
					<div class="col-xs-3">
						<label class="label_name" for="form-field-2"> 收件人电话： </label> <input
							type="text" name="name" style="height: 25px" />
					</div>
					<div class="col-xs-3">
						<label class="label_name" for="form-field-2"> 收件地邮编： </label> <input
							type="text" name="name" style="height: 25px" />
					</div>
					<div class="col-xs-3">
						<label class="label_name" for="form-field-2"> 收件地址： </label> <input
							type="text" name="name" style="height: 25px" />
					</div>
					<div class="col-xs-12">
						<label class="label_name" for="form-field-2">备注说明： </label> <input
							type="text" name="name" style="height: 25px" />
					</div>
				</div>
			</div>
			...
			<div class="Button_operation">
				<button onclick="article_save_submit();"
					class="btn button_btn bg-deep-blue margin-top" type="submit">
					<i class="icon-save "></i>返回上一步
				</button>
				<button onclick="layer_close();" class="btn btn-default button_btn"
